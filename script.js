function mostrarInformacion() {
    ...
    //permite saber si el usuario ingreso un correo electronico
    if(correo.indexOf('@') === -1){
      alert("Che ingresa el correo con @ por favor");
      return;
    }
    ...
    if (elemento) {
      ...
      console.error("No se encontro los datos del comprador");
    }
}
